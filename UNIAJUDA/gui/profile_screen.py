...
class ProfileScreen:
    ...
    def render_profile(self):
        ...
        if user:
            tk.Label(self.parent, text=f"Nome: {user.nome}", font=("Arial", 13), bg="#f8fafc").pack(anchor="w", padx=30)
            tk.Label(self.parent, text=f"Matrícula: {user.matricula}", font=("Arial", 13), bg="#f8fafc").pack(anchor="w", padx=30)
            tk.Label(self.parent, text=f"Curso: {user.curso}", font=("Arial", 13), bg="#f8fafc").pack(anchor="w", padx=30)
